...
class PolygonTests {
    ...
    public void testFindIntersections() {
        ...
        Ray ray3 = new Ray(new Point(0, 0, 0.5), new Vector(0, 0, 0.5));
        assertNull(polygon.findIntersections(ray3), "Intersection at vertex should return null");

        // TC04: Ray intersects on edge
        Ray ray4 = new Ray(new Point(0, 0, 0.5), new Vector(0.5, 0, 0.5));
        assertNull(polygon.findIntersections(ray4), "Intersection on edge should return null");

        // TC05: Ray starts inside polygon
        Ray ray5 = new Ray(new Point(0.3, 0.4, 0.3), new Vector(9, 10, 1));
        assertNull(polygon.findIntersections(ray5), "Ray starts inside polygon should return null");

        // TC06: Ray is parallel to polygon plane — no intersection
