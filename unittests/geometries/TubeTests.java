...
class TubeTests {
    ...
    void testConstructor() {
        ...
        Tube tube = new Tube(5, new Ray(Point.ZERO, new Vector(0, 0, 7)));
        assertEquals(5, tube.getRadius(), "The radius of the tube is incorrect");
        assertEquals(new Ray(Point.ZERO, new Vector(0, 0, 7)), tube.getAxis(), "The axis ray of the tube is incorrect");
        // =============== Boundary Values Tests ==================
        //TC02: Test that the tube is created with a negative radius
        assertThrows(IllegalArgumentException.class, () -> new Tube(-5, new Ray(Point.ZERO, new Vector(0, 0, 7))),
                "Constructed a tube with a negative radius");
        //TC03: Test that the tube is created with a zero radius
        assertThrows(IllegalArgumentException.class, () -> new Tube(0, new Ray(Point.ZERO, new Vector(0, 0, 7))),
    ...
    void testGetNormal() {
        ...
        Tube tube = new Tube(1, new Ray(Point.ZERO, new Vector(0, 0, 5)));
