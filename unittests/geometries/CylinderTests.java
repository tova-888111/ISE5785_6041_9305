...
class CylinderTests {
    ...
    void testConstructor() {
        ...
        Cylinder cylinder = new Cylinder(5, new Ray(Point.ZERO, new Vector(0, 0, 7)), 5);
        assertEquals(5, cylinder.getRadius(), "The radius of the cylinder is incorrect");
        assertEquals(new Ray(Point.ZERO, new Vector(0, 0, 7)), cylinder.getAxis(), "The axis ray of the cylinder is incorrect");
        ...
        assertThrows(IllegalArgumentException.class, () -> new Cylinder(-5, new Ray(Point.ZERO, new Vector(0, 0, 7)), 5),
                "Constructed a cylinder with a negative radius");

        //TC03: Test that the cylinder is created with a zero radius
        assertThrows(IllegalArgumentException.class, () -> new Cylinder(0, new Ray(Point.ZERO, new Vector(0, 0, 7)), 5),
        ...
        assertThrows(IllegalArgumentException.class, () -> new Cylinder(5, new Ray(Point.ZERO, new Vector(0, 0, 7)), 0),
    ...
    void testGetNormal() {
        ...
        assertEquals(Vector.AXIS_X, cylinder.getNormal(new Point(5, 0, 2)), "The normal vector is incorrect");
        //TC02: Test that the normal of the cylinder is correct when the point is on the top base of the cylinder
        assertEquals(Vector.AXIS_Z, cylinder.getNormal(new Point(1, 0, 5)), "The normal vector is incorrect");
        ...
        assertEquals(Vector.AXIS_Z, cylinder.getNormal(new Point(5, 0, 5)), "The normal vector is incorrect");
        ...
        assertEquals(Vector.AXIS_Z, cylinder.getNormal(new Point(0, 0, 5)), "The normal vector is incorrect");
        //TC07: Test that the normal of the cylinder is correct when the point is the center of the bottom base of the cylinder
        assertEquals(new Vector(0, 0, -1), cylinder.getNormal(Point.ZERO), "The normal vector is incorrect");
    }
}