...
class Mp2Tests {
    ...
    Geometries geometries = new Geometries(
            ...
            //Center
            new Sphere( 2.5,new Point(0, 0.5, -17.25))
    ...
    List<LightSource> lights = List.of(
            // The point light is in the top left corner
            new PointLight(new Color(80, 60, 60), new Point(-8, 12, 8))
                    .setKl(0.012).setKq(0.0015),
            // The spotLight is in the top right corner, the light is directed downwards and to the left
            new SpotLight(new Color(160, 125, 80), new Point(8, 8, 6), new Vector(-1, -1, -2))
                    .setKl(0.012).setKq(0.0015),
            // The spotlight to the sun
            // The Spotlight is in the up right corner, the direction is forward
            new SpotLight(new Color(80, 60, 60), new Point(30, 26, 0), new Vector(0, 0, -1))
                    .setKl(0.012).setKq(0.0015),
            // The directional light is directed downwards and to the left
            new DirectionalLight(new Color(70, 70, 70), new Vector(-0.3, -0.5, -1)),
            // The directional light is directed downwards
            new DirectionalLight(new Color(70, 70, 70), new Vector(0, -1, 0)),
            // The directional light is directed upwards and to the left
            new DirectionalLight(new Color(70, 70, 70), new Vector(-1, 0, 1)),
            // The directional light is directed left
